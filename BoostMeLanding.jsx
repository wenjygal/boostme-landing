        ...
        <Reveal>
          ...
          >
            <p style={{ color: "#6b5f52", fontSize: 14.5, margin: 0 }}>
              ויש עוד ביד: אודיט לדף נחיתה או לבוט קיים, אפליקציות (CRM, דשבורדים, טיפול בלידים), הקמת מדידה (GTM, GA4, Clarity), ספרי פרומפטים אינטראקטיביים לצוותים, וידאו הסברה, מיצוב ומותג, שאלונים אינטראקטיביים, תוכן וקופי לקמפיינים, ואסטרטגיית SEO / AEO / GEO.
            </p>
          </div>
        </Reveal>
