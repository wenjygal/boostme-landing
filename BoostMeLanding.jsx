...
const SERVICES = [
  {
    ...
    time: "משך הבנייה: 3-5 ימי עבודה מרגע תחילת הבנייה (לא כולל אישור הצעה)",
  ...
  },
  {
    ...
    time: "משך הבנייה: פגישת זום אחת, וסיכום תוך 2 ימי עבודה מרגע תחילת הבנייה (לא כולל אישור הצעה)",
    accent: BRAND.orange,
    badge: null,
  },
  {
    ...
    time: "משך הבנייה: מותאם, סדנה בודדת או סדרה",
